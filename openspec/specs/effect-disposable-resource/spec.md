# effect-disposable-resource

## Purpose

Define the resource-oriented contract returned by baseline effects so effect teardown can be managed consistently with other disposable and unsubscribable resources.
